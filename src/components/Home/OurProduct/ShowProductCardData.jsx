    ...
    <div className=' product-bg  xl:w-[350px] w-[280px] h-[200px] xl:h-[200px] relative  rounded-lg shadow px-5 py-5'>
      <div className='card-hover'>
        ...
        <div className=' flex justify-between items-center'>
          <button className='flex xl:mt-6 mt-4 gap-2 items-center justify-center text-[#1C008A] text-[13px] font-semibold leading-normal'>
            Explore More <img draggable={false} src={arrowImg} alt='Arrow Image' />
          </button>
        </div>
      </div>
    </div>
