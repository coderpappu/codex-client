...
import MegaMenu from "../../../src/components/Shared/MegaMenu/MegaMenu";

const DeshboardDekstopMenu = () => {
  ...
  const inactiveMenu = "block text-[14px] py-2 font-semibold";
  const activeMenu =
    "block text-[14px] border-[2px] rounded-md text-center px-6 border-[#7F7CFF] py-1 font-semibold ";
  ...
  return (
    <>
      {" "}
      <ul className="flex flex-col items-center p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white text-black">
        <li>
          <Link
            to="/"
        ...
        <li className="relative" ref={menuRef}>
          <button className=" items-center flex gap-2 " onClick={toggleMenu}>
            Services{" "}
...
export default DeshboardDekstopMenu;
